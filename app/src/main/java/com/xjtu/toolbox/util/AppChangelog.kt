...
object AppChangelog {
    ...
    val ENTRIES: List<Pair<String, VersionChangelog>> = listOf(
        ...
        "5.0" to VersionChangelog(
            items = listOf(
                "🪶" to "无望其速成，无诱于势利。",
                "⛵" to "多数页推翻重构，所有页里外翻新，全部适配大屏。忒修斯之船换完了最后一块木板，它还叫岱宗盒子吗？",
                "🌿" to "新增玻璃、灵动动画、转场、振动，所谓生命力是也",
                "♟️" to "新增小游戏：合成仙交大、GPA 2048、各种棋，可联机对弈。这里的高分比GPA好拿",
                "🧭" to "Agent 翻新：UI 重做、提示词和工具打磨了一遍，准确度指数级提升",
                "🗂️" to "通知搜索、调停补课、学籍信息、思源学堂等等等等优化，反正无人在意",
                "🍂" to "Class 回放、图书馆地图等下线，旧的不去新的不来",
                "🪡" to "你们反馈过的 bug 一个不落全修了；没反馈的，大概也修了",
                "⛰️" to "天门一长啸，万里清风来。",
            )
        ),
